...
export default function UpdateListing() {
    ...
    const handelSubmit = async(e) =>{
        ...
        try{
            ...
            setLoading(true);
            setError(false);
            const res = await fetch(`/api/listing/editlisting/${listingId}/${currentUser._id}`,{
                method:'POST',
                headers:{
        ...
        <div>
           ...
           <div className='flex gap-3'>
            <div className='flex gap-2 py-3'>
                <input type="number" max='10' min='1' name="beds" id="bedrooms" className='h-18 w-30 border-none rounded-lg' onChange={handelChange} checked={formData.bedrooms} value={formData.bedrooms}/>
                <span>Beds</span>
            </div>
            <div className='flex gap-2 py-3'>
                <input type="number" max='5' min='1' name="bath" id="bathrooms" className='h-16 w-30 border-none rounded-lg' onChange={handelChange} checked={formData.bathrooms} value={formData.bathrooms}/>
                <span>Baths</span>
            </div>
           </div>
           <div className='flex flex-row gap-2'>
           <div className='flex gap-2'>
            <input type="number" className='w-40 h-14 border-none rounded-lg' id='regularPrice' min='50' onChange={handelChange} checked={formData.regularPrice} value={formData.regularPrice}/>
           ...
           {formData.offer && (
            <div className='flex gap-2'>
            <input type="number" className='w-40 h-14 border-none rounded-lg' id='discountPrice' min='0' onChange={handelChange} checked={formData.discountPrice} value={formData.discountPrice}/>
            <div className='flex flex-col'>
